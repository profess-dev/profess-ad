...
# ----------------------------------------------------------------------------------------
# An improved LBFGS optimizer for PyTorch from the public repository
# https://github.com/nlesc-dirac/pytorch 
# owned by Distributed Radio Astronomical Computing (DIRAC) 
# and licensed under Apache License 2.0

# Further details are given in the publication
# https://ieeexplore.ieee.org/document/8755567
# (Authors: Sarod Yatawatta, Lukas De Clercq, Hanno Spreeuw, Faruk Diblen)

# Modifications made to original code:
# Commented out torch.set_grad_enabled() lines to prevent 
# interference on higher-order gradient dependent losses.
# (Lines 698 and 703 in https://github.com/nlesc-dirac/pytorch/blob/master/lbfgsnew.py,
# lines 701 and 706 in this modified script)
# ---------------------------------------------------------------------------------------
